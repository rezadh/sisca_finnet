...
Widget customDropDownUserVp(BuildContext context, UserVp item) {
  if (item == null) {
    return Container();
  }
...
Widget customPopupItemBuilderUserVp(
    BuildContext context, UserVp item, bool isSelected) {
  return Container(
...
RenderBox findBorderBoxUserVp(RenderBox box) {
  RenderBox borderBox;
  ...
  box.visitChildren((child) {
    ...
    final box = findBorderBoxUserVp(child as RenderBox);
    if (box != null) {
      borderBox = box;
    }
  });
